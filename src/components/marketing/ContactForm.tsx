    ...
    const onSubmit = async (data: ContactFormData) => {
        try {
            ...
            if (axios.isAxiosError(error) && error.response) {
                ...
                const firstError = validationErrors ? Object.values(validationErrors).flat()[0] as string : "Ocorreu um erro.";
        ...
        <div className="bg-card rounded-xl p-6 sm:p-8 shadow-sm border border-border">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                    ...
                    <Input id="phone" {...register('phone')} type="tel" placeholder="(XX) XXXXX-XXXX" className="mt-1" />
