...
import { RecipeDifficultyEnum, type RecipeCategory } from '@/types/recipe';
            ...
            <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <Input id="portion" type="number" {...register('portion')} />
                    ...
                    <div>
                        ...
                        <Controller name="difficulty" control={control} render={({ field }) => (
                            <Select onValueChange={field.onChange} value={field.value}>
                                ...
                                <SelectContent>
                                    {Object.values(RecipeDifficultyEnum).map(d => <SelectItem key={d} value={d}>{d}</SelectItem>)}
                                </SelectContent>
                            </Select>
                        )} />
